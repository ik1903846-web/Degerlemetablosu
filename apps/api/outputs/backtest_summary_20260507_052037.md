# REELDEĞER Backtest Summary — 20260507_052037
...
|---------|------|-----------:|-----------:|----:|-------:|--------:|-------:|
| konservatif | zero | +1230.92% | +72.45%/yr | 55.29% | 1.24 | 5.19 | -16.64% |
| konservatif | realistic | +1200.25% | +71.61%/yr | 55.29% | 1.22 | 5.13 | -16.78% |
| dengeli | zero | +1089.98% | +68.43%/yr | 52.37% | 1.23 | 5.16 | -15.70% |
| dengeli | realistic | +1062.60% | +67.61%/yr | 52.37% | 1.21 | 5.10 | -15.84% |
| agresif | zero | +996.96% | +65.57%/yr | 50.29% | 1.22 | 5.14 | -15.03% |
| agresif | realistic | +971.74% | +64.76%/yr | 50.29% | 1.21 | 5.07 | -15.16% |
...
|--------|--:|-----------:|------:|
| normal | 12 | +270.01% | +13.54% |
| moderate_stress | 4 | +121.03% | +26.39% |
| significant_stress | 1 | +5.41% | +5.41% |
| panic | 2 | +38.04% | +18.89% |
...
|--------|-----------:|-------------:|
| core | 7.33% | +220.69% |
| yuksek_kazanc | 2.00% | +90.54% |

## 5-Failure Metric Tracker (realistic cost)

| Profile | Trading Cost | Turnover | Tax Drag | Cash Avg | Style |
|---------|------------:|---------:|---------:|---------:|-------|
| konservatif | 0.05%/yr [OK] | 34.26%/yr [PASSIVE] | 0.50%/yr [OK] | 0.00% [OVERINVESTED] | STABLE (MVP fixed weights) |
| dengeli | 0.05%/yr [OK] | 32.08%/yr [PASSIVE] | 0.50%/yr [OK] | 0.00% [OVERINVESTED] | STABLE (MVP fixed weights) |
| agresif | 0.05%/yr [OK] | 30.66%/yr [PASSIVE] | 0.50%/yr [OK] | 0.00% [OVERINVESTED] | STABLE (MVP fixed weights) |

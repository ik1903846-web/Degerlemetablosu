# REELDEĞER Backtest Summary — 20260508_010315
...
|---------|------|-----------:|-----------:|----:|-------:|--------:|-------:|
| konservatif | zero | +525.72% | +47.12%/yr | 44.91% | 0.96 | 3.68 | -18.13% |
| konservatif | realistic | +511.10% | +46.39%/yr | 44.91% | 0.94 | 3.61 | -18.26% |
| dengeli | zero | +527.12% | +47.18%/yr | 44.57% | 0.97 | 3.78 | -17.91% |
| dengeli | realistic | +512.46% | +46.45%/yr | 44.56% | 0.95 | 3.71 | -18.05% |
| agresif | zero | +528.07% | +47.23%/yr | 44.33% | 0.98 | 3.84 | -17.76% |
| agresif | realistic | +513.37% | +46.50%/yr | 44.32% | 0.96 | 3.78 | -17.89% |
...
|--------|--:|-----------:|------:|
| normal | 12 | +144.25% | +9.21% |
| moderate_stress | 4 | +80.36% | +19.42% |
| significant_stress | 1 | +8.72% | +8.72% |
| panic | 2 | +30.94% | +15.39% |
...
|--------|-----------:|-------------:|
| core | 4.19% | +204.82% |
| yuksek_kazanc | 0.29% | +22.89% |

## 5-Failure Metric Tracker (realistic cost)

| Profile | Trading Cost | Turnover | Tax Drag | Cash Avg | Style |
|---------|------------:|---------:|---------:|---------:|-------|
| konservatif | 0.04%/yr [OK] | 26.93%/yr [PASSIVE] | 0.50%/yr [OK] | 2.00% [OVERINVESTED] | STABLE (MVP fixed weights) |
| dengeli | 0.04%/yr [OK] | 27.33%/yr [PASSIVE] | 0.50%/yr [OK] | 2.00% [OVERINVESTED] | STABLE (MVP fixed weights) |
| agresif | 0.04%/yr [OK] | 27.63%/yr [PASSIVE] | 0.50%/yr [OK] | 2.00% [OVERINVESTED] | STABLE (MVP fixed weights) |

...
async def main():
    ...
    # ========================================================================
    print(f"\n[TEST 2] BIST {len(BIST_200)} ticker — auto-fetch all prices")
    ...
    print(f"  BIST 200 additions: {len(BIST_200_ADDITIONS)} (Faz 4.22 mid-cap layer)")
    print("-"*80)
    ...
    print(f"  Duration: {duration:.1f}s ({len(BIST_200)} ticker)")

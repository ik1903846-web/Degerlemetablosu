...
async def main():
    ...
    # ========================================================================
    print(f"\n[TEST 2] BIST {len(BIST_TUM)} ticker — auto-fetch all prices")
    ...
    print(f"  BIST 200 additions: {len(BIST_200_ADDITIONS)} (Faz 4.22 mid-cap)")
    print(f"  BIST TÜM additions: {len(BIST_TUM_ADDITIONS)} (Faz 4.23 küçük cap layer)")
    print("-"*80)
    ...
    print(f"  Duration: {duration:.1f}s ({len(BIST_TUM)} ticker)")
